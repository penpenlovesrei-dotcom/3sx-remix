...
extern const u8 use_scr[58];
extern const u8 use_real_scr[58];
extern const u8 use_family[58];
extern const u8 rewrite_scr[58];
extern const u8 use_scr2[7];
extern const u8 stage_bgw_number[58][4];
extern const s32 msp[58][3][2];
...
extern const u32 bgtex_stage_gbix[58][4];
extern const u32 bgtex_etc_gbix[7];
extern const u32 stage_priority[58];
extern const u32 etc_bg_priority[7];
extern const u8 stage_opaque[58];
extern const s8 bgrw_on[58][8];
...
extern const u8 ake_bg_off[58];
extern const s16 limit_tbl3[58][3][4];
extern const s8 bg_index_tbl[58][3];
extern const s32 bg_pos_tbl2[7][3][2];
extern const s8 quake_x_tbl[130];
extern const s8 quake_y_tbl[130];
extern const u16* bg_map_tbl[][4];
