...
const s16 scr_obj_num[23] = { 0, 2, 0, 0, 0, 2, 1, 0, 3, 1, 0, 1, 1, 1, 1, 2, 2, 0, 2, 4, 1, 4,
...
u32* char_add[23] = { _fnl_char_table, _usa_char_table, _j10_char_table, _hkg_char_table, _eng_char_table,
    ...
    _fnl_char_table /* etage 22, copie de 0 */
};

const s16* scr_obj_data[23] = { stg_dum_data_tbl, stg0100_data_tbl, stg_dum_data_tbl, stg_dum_data_tbl,
    ...
    stg_dum_data_tbl /* etage 22, copie de 0 */
};
